...
*Note: DeathResolution is engine-only logic. Last words are generated by the engine based on role, not AI prompts.*
...
**System Prompt:**
```
You are casting your vote on Day {day} to banish a suspected werewolf.
