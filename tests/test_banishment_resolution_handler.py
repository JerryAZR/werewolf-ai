...
4. Sheriff banished -> badge transfer
...
class TestBanishmentResolutionNoBanishment:
    ...
    def test_no_banished_empty_subphase_log(self):
        ...
        result = handler(context, banishment_input)
    ...
    def test_no_banished_tie_voting(self):
...
class TestBanishmentResolutionLastWords:
    ...
    def test_banished_player_with_last_words(self):
    ...
    def test_banished_player_last_words_day_3(self):
    ...
    def test_werewolf_last_words(self):
    ...
    def test_witch_last_words(self):
    ...
    def test_guard_last_words(self):
...
class TestBanishmentResolutionHunterShoot:
    ...
    def test_hunter_banished_can_shoot(self, random_seed):
    ...
    def test_non_hunter_banished_no_shoot_target(self):
    ...
    def test_hunter_banished_prefers_werewolf_target(self):
    ...
    def test_hunter_banished_last_words(self):
...
class TestBanishmentResolutionSheriffBadge:
    """Tests for sheriff badge transfer on banishment."""

    def test_sheriff_banished_badge_transfers(self):
        """Test sheriff banishment transfers badge to next living player."""
    ...
    def test_non_sheriff_banished_no_badge_transfer(self):
    ...
    def test_sheriff_banished_no_trusted_heir(self):
        ...
        death_event = result.subphase_log.events[0]
        # All living are werewolves, so badge transfer skipped
        assert death_event.badge_transfer_to is None
...
class TestBanishmentResolutionHunterSheriff:
    ...
    def test_hunter_sheriff_banished_both_shoot_and_badge(self):
...
class TestBanishmentResolutionRoleBehaviors:
    ...
    def test_werewolf_banished(self):
    ...
    def test_villager_banished(self):
    ...
    def test_all_roles_banished_have_last_words(self):
...
class TestBanishmentResolutionDebugInfo:
    ...
    def test_debug_info_contains_banished_seat(self):
    ...
    def test_debug_info_contains_last_words_flag(self):
    ...
    def test_debug_info_contains_hunter_shoot(self):
    ...
    def test_debug_info_contains_badge_transfer(self):
...
class TestBanishmentResolutionEdgeCases:
    ...
    def test_banished_player_not_in_players_dict(self):
    ...
    def test_banished_last_player(self):
    ...
    def test_banished_sheriff_last_player(self):
    ...
    def test_banished_hunter_only_werewolf_survives(self):
...
class TestBanishmentResolutionIntegration:
    ...
    def test_complete_day_2_banishment(self):
    ...
    def test_sheriff_banished_trust_heir(self):
        """Test sheriff banished chooses trusted heir."""
        players = {
            0: Player(seat=0, name="W1", role=Role.WEREWOLF, is_alive=True),
            4: Player(seat=4, name="Sheriff", role=Role.SEER, is_alive=True, is_sheriff=True),
            5: Player(seat=5, name="Witch", role=Role.WITCH, is_alive=True),
    ...
    def test_day_5_no_last_words_exception(self):
...
class TestBanishmentResolutionPhases:
    ...
    def test_microphase_is_banishment_resolution(self):
    ...
    def test_day_number_matches_input(self):
